"""
Knowledge Manager - Ürün bilgi tabanı yönetimi
"""
...
class KnowledgeManager:
    """
    Ürün bilgi tabanını yönetir
    - Ürün bilgilerini depolar ve getirir
    - Dokümantasyonu indexler
    - Vektör arama ile ilgili bilgileri bulur
    """
